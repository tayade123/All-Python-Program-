...
#changing the logo
logo = pygame.image.load('F:\mon.png')
...
def gameloop():
    ...
    bg = pygame.image.load('F:\mon.png')

    
    # setting our player
    maincar = pygame.image.load('F:\mon.png')
    maincarX = 350
    maincarY = 495
    maincarX_change = 0
    maincarY_change = 0
    ...
    #other cars
    car1 = pygame.image.load('F:\mon.png')
    car1X = random.randint(178,490)
    car1Y = 100

    car2 = pygame.image.load('F:\mon.png')
    car2X = random.randint(178,490)
    car2Y = 100

    car3 = pygame.image.load('F:\mon.png')
